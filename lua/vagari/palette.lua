return {
	...
	ivy_0 = "#2d9a43", -- CR: 4.20
	ivy_1 = "#48a95b", -- CR: 5.12
	ivy_2 = "#5aba6d", -- CR: 6.26
	ivy_3 = "#5fc976", -- CR: 7.29
	ivy_4 = "#76d78b", -- CR: 8.56
	...
	cy2_0 = "#2bb198", -- CR: 5.66
	cy2_1 = "#30c9b0", -- CR: 7.29
	cy2_2 = "#38d2ba", -- CR: 8.00
	cy2_3 = "#50dec8", -- CR: 9.11
	cy2_4 = "#75e6d5", -- CR: 10.12
